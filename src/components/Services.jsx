...
const services = [
  {
    title: 'Visual Design',
    description: 'Crafting compelling visual narratives that bring brands to life through thoughtful design.',
    icon: (
  ...
  {
    title: 'UI/UX Design',
    description: 'Designing intuitive user experiences that balance aesthetics with usability.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    title: 'Web Design',
    description: 'Building modern, responsive websites that deliver seamless digital experiences.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: 'Creating cohesive brand systems that communicate a unique story and vision.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: 'Turning designs into performant, interactive code with modern frameworks.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: 'Guiding creative vision from concept to execution for impactful digital products.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
